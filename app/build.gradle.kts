...
android {
    namespace = "com.stu71205.ca2_movie_booking_app"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.stu71205.ca2_movie_booking_app"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    ...
    debugImplementation ("androidx.compose.ui:ui-test-junit4:1.2.0-alpha07")
